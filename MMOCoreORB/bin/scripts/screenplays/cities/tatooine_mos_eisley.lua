TatooineMosEisleyScreenPlay = CityScreenPlay:new {
	...
	stationaryMobiles = {
		...
		{1, 3377.1, 5, -4864.9, 7, 0, "npc_sitting_chair"}, {1, 3414.1, 5, -4629.9, 155, 0, "npc_sitting_chair"}, {1, 3415.9, 5, -4630.2, 60, 0, "npc_use_terminal_high"}, {1, 3371.5, 5, -4858.4, 210, 0, "npc_use_terminal_high"},
		{1, 3397.3, 5, -4689.8, 88, 0, "npc_use_terminal_high"}, {1, 3285.75, 5, -4923.4, 54, 0, ""}, {1, 3482.43, 5, -5002.18, 227, 0, ""}, {1, 3232.74, 5, -4798.26, 202, 0, ""},
		...
		{1, 3535.1, 4, -4724.2, 275, 0, "conversation"}, {1, 3354.2, 5, -4824.3, 330, 0, "worried"}, {1, 3697.52, 5, -4757.76, 158, 0, ""}, {1, 3650.15, 5, -4860.75, 108, 0, ""},
