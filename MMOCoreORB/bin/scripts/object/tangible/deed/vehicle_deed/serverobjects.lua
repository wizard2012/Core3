...
-- E1 (SWGWar B61): the hover fighters' trial deeds
includeFile("tangible/deed/vehicle_deed/war_xwing_deed.lua")
includeFile("tangible/deed/vehicle_deed/war_tie_deed.lua")
